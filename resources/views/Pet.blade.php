        ...
        <div class="row justify-content-evenly pb-5">
            <div class="col-md-6 mx-auto">
                <div class="input-group">
                    <input class="form-control border-end-0 rounded-pill search bg-body-tertiary search-text" list="datalistOptions" id="exampleDataList" placeholder="Search for anything">
